...
public class Board {
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		// Checks if the player has three consecutive marks in the diagonal that runs from the top-right to the bottom-left.
		//If so, the method returns true, indicating a win.
